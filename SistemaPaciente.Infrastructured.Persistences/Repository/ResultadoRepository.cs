...
{
    public class ResultadoRepository : GenericRepository<ResultadoLaboratorio>, IResultadoRepository
    {
        private readonly SistemaPacienteContext _context;
        public ResultadoRepository(SistemaPacienteContext context) : base(context)=> _context = context;
    }
}
